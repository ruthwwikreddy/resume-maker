    ...
    <footer className="border-t border-foreground/5 py-16">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm text-foreground/35 leading-relaxed">
              Professional resumes, effortlessly built. Clean, modern, and free.
            </p>
          </div>
        ...
        <div className="border-t border-foreground/5 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-foreground/25">© {currentYear} ResumeGen</p>
          <div className="flex gap-5">
            <a href="#" className="text-foreground/25 hover:text-foreground transition-colors duration-300" aria-label="Twitter">
            ...
            <a href="#" className="text-foreground/25 hover:text-foreground transition-colors duration-300" aria-label="LinkedIn">
            ...
            <a href="#" className="text-foreground/25 hover:text-foreground transition-colors duration-300" aria-label="GitHub">
