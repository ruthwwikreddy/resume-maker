  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-foreground tracking-tight">Skills</h2>
        <Button 
      ...
      {skills.length === 0 ? (
        <div className="empty-state">
          <p>No skills added yet. Click the button above to add one.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {skills.map((skill, index) => (
            <Card key={skill.id} className="form-card border-foreground/10 bg-transparent shadow-none">
